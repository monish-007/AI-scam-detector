    ...
    <div className="space-y-4 md:space-y-6">
      <div className="card p-4 md:p-5">
        <div className="card-header">
          <div>
            <h3 className="card-title">Image scanner</h3>
            <p className="text-xs text-slate-500">
              Upload screenshots of chats, emails or web pages and extract text
              with OCR.
            </p>
          </div>
        </div>
        <div className="space-y-3 text-xs">
          ...
          <p className="text-[11px] text-slate-500">
            Extracted text is analysed with the same NLP scam detector as
            messages.
          </p>
        </div>
      </div>
